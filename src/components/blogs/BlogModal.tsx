    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="flex flex-wrap gap-2 text-sm text-burnLight">
            {tech.join(" - ")}
          </div>
          ...
          <div>
            <p className="font-bold mb-2 text-xl">
              Project Links<span className="text-burn">.</span>
            </p>
            <div className="flex items-center gap-4 text-sm">
              <Link
                target="_blank"
                rel="nofollow"
                className="text-zinc-300 hover:text-burnLight transition-colors flex items-center gap-1"
                href={code}
              >
